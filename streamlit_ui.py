...
if secrets_loaded:
    ...
    async def main():
        ...
        # Pass relevant clients/variables to the tabs if needed
        if st.session_state.selected_tab == "Intro":
            ...
            await chat_tab() # Pass openai_client if needed: await chat_tab(openai_client)
            ...
            database_tab(supabase) # Pass the supabase client
        elif st.session_state.selected_tab == "Documentation":
            st.title("Archon - Documentation")
            documentation_tab(supabase) # Pass the supabase client
